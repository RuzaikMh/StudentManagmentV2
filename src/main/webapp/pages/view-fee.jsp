            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow mb-nav">
                        ...
                        <a class="navbar-brand d-sm-none-max"><i class="fas fa-user"></i> View Fees </a>

                        <a href="new-fee" class="btn btn-primary ml-auto btn-icon-split">
                            <span class="icon text-white-50">
                                <i class="fas fa-arrow-right"></i>
                            </span>
                            <span class="text">New Fee</span>
                        </a>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4 d-txt-none-s">
                            <h1 class="h3 mb-0 text-gray-800">Fee Details</h1>
                        </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card shadow mb-4">
                                    <div
                                        ...
                                        <h6 class="m-0 font-weight-bold text-primary card-title-hide">Fees List</h6>
